...
//]]>
        ...
        <div class="card ">
            <div class="card-body ">
                <div class="d-sm-flex align-items-center">
                    <div class="mr-auto">
                        <div class="page-context-header"><div class="page-header-headings"><h1>Курс по Ansible</h1></div></div>
                    </div>
    ...
    <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <a href="/Lessons-Ansible.php" aria-current="page" title="Celebrating Cultures">Курс по Ansible</a>
                </li>
        </ol>
</nav>
                    </div>
        ...
        <div id="page-content" class="row pb-3 d-print-block">
            <div id="region-main-box" class="col-12">
                <section id="region-main" class="has-blocks mb-3" aria-label="Content">
                    ...
                    <div role="main"><span id="maincontent"></span><div class="course-content"><h2 class="accesshide">Topic outline</h2><ul class="topics"><li id="section-0" class="section main clearfix" role="region" aria-labelledby="sectionid-458-title" data-sectionid="0" data-sectionreturnid="0"><div class="left side"></div><div class="right side"><img class="icon spacer" width="1" height="1" alt="" aria-hidden="true"/></div><div class="content"><h3 id="sectionid-458-title" class="text-center"><span><a><big><big>Страница курса Ansible</big></big></a></span></h3><div class="section_availability"></div><div class="summary"><div class="text-center"><p><big><big>Ниже представлены лекции, которые вы можете прослушать в течение всего курса</big></big></p></div></div><ul class="section img-text">

                    <li class="activity data modtype_data  " id="module-649"><div><div class="mod-indent-outer w-100"><div class="mod-indent"></div><div><div class="activityinstance"><a class="aalink" onclick="" href="/Common-Installer-lessons.php"><img src="https://www.redhat.com/misc/favicon.ico" class="iconlarge activityicon" alt="" role="presentation" aria-hidden="true" /><span class="instancename"><big><big>Чтение "Ansible Automation Platform Quick Installation GuideFile" - Лекция №1</big></big></span></a></div><div class="contentafterlink"><div class="no-overflow"><div class="no-overflow"></div></div></div></div></div></div></li>

<li class="activity data modtype_data  " id="module-649"><div><div class="mod-indent-outer w-100"><div class="mod-indent"></div><div><div class="activityinstance"><a class="aalink" onclick="" href="/Common-Installer-lessons.php"><img src="https://www.redhat.com/misc/favicon.ico" class="iconlarge activityicon" alt="" role="presentation" aria-hidden="true" /><span class="instancename"><big><big>Чтение "Ansible Tower Quick Setup GuideFile" - Лекция №2</big></big></span></a></div><div class="contentafterlink"><div class="no-overflow"><div class="no-overflow">
</div></div></div></div></div></div></li>

<li class="activity data modtype_data  " id="module-649"><div><div class="mod-indent-outer w-100"><div class="mod-indent"></div><div><div class="activityinstance"><a class="aalink" onclick="" href="/Common-Installer-lessons.php"><img src="https://www.redhat.com/misc/favicon.ico" class="iconlarge activityicon" alt="" role="presentation" aria-hidden="true" /><span class="instancename"><big><big>Чтение "Ansible Administration GuideFile" - Лекция №3</big></big></span></a></div><div class="contentafterlink"><div class="no-overflow"><div class="no-overflow">
</div></div></div></div></div></div></li>

<li class="activity data modtype_data  " id="module-649"><div><div class="mod-indent-outer w-100"><div class="mod-indent"></div><div><div class="activityinstance"><a class="aalink" onclick="" href="/Common-Installer-lessons.php"><img src="https://www.redhat.com/misc/favicon.ico" class="iconlarge activityicon" alt="" role="presentation" aria-hidden="true" /><span class="instancename"><big><big>Чтение "Ansible User GuideFile" - Лекция №4</big></big></span></a></div><div class="contentafterlink"><div class="no-overflow"><div class="no-overflow">
</div></div></div></div></div></div></li>
