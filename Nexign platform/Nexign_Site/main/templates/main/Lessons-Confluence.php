...
<head>
    <title>Курс по Confluence</title>
...
//]]>
        ...
        <div class="card ">
            <div class="card-body ">
                <div class="d-sm-flex align-items-center">
                    <div class="mr-auto">
                        <div class="page-context-header"><div class="page-header-headings"><h1>Курс по Confluence</h1></div></div>
                    </div>
    ...
    <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <a href="/Lessons-Confluence.php" aria-current="page" title="Celebrating Cultures">Курс по Confluence</a>
                </li>
        </ol>
</nav>
                    </div>
