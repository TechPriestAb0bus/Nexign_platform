...
<head>
    <title>Курс по Common Installer</title>
...
//]]>
        ...
        <div class="card ">
            <div class="card-body ">
                <div class="d-sm-flex align-items-center">
                    <div class="mr-auto">
                        <div class="page-context-header"><div class="page-header-headings"><h1>Курс по Common Installer</h1></div></div>
                    </div>
    ...
    <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <a href="video.php" aria-current="page" title="Celebrating Cultures">Курс по Common Installer</a>
                </li>
        </ol>
</nav>
                    </div>
