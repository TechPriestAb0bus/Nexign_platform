...
M.cfg = {"wwwroot":"https:\/\/school.moodledemo.net","sesskey":"tTqj898SaK","sessiontimeout":"7200","sessiontimeoutwarning":1200,"themerev":"1636912874","slasharguments":1,"theme":"boost","iconsystemmodule":"core\/icon_system_fontawesome","jsrev":"1636912874","admin":"admin","svgicons":true,"usertimezone":"UTC+1","contextid":1033,"langrev":1636912874,"templaterev":"1636912874"};var yui1ConfigFn = function(me) {if(/-skin|reset|fonts|grids|base/.test(me.name)){me.type='css';me.path=me.path.replace(/\.js/,'.css');me.path=me.path.replace(/\/yui2-skin/,'/assets/skins/sam/yui2-skin')}};
...
//]]>
    ...
    <nav class="fixed-top navbar navbar-light bg-white navbar-expand moodle-has-zindex" aria-label="Site navigation">
            ...
            <div class="ml-auto">
                <div id="searchinput-navbar-619161357d8506191613573b276" class="simplesearchform">
    ...
    <div class="popover-region-toggle nav-link icon-no-margin"
        ...
        role="button"
        aria-controls="popover-region-container-619161357dfa66191613573b277"
        aria-haspopup="true"
    ...
    <div 
        id="popover-region-container-619161357dfa66191613573b277"
...
<li class="activity resource modtype_resource  " id="module-762"><div><div class="mod-indent-outer w-100"><div class="mod-indent"></div><div><div class="activityinstance"><a class="aalink" onclick="" href="Lessons-Docker.php"><img src="https://icon2.cleanpng.com/20180527/aye/kisspng-docker-github-node-js-mongodb-computer-software-5b0a34af260146.0636816215273955031557.jpg" class="iconlarge activityicon" alt="" role="presentation" aria-hidden="true" /><span class="instancename"><big><big>Docker</big></big><span class="accesshide " > File</span></span></a></div><div class="contentafterlink"><div class="no-overflow"><div class="no-overflow"><p><big>Программное обеспечение для автоматизации развёртывания и управления приложениями в средах с поддержкой контейнеризации, контейнеризатор приложений.</big></i></p></div></div></div></div></div></div></li></ul></div></li><li id="section-2" class="section main clearfix hidden" role="region" aria-labelledby="sectionid-484-title" data-sectionid="2" data-sectionreturnid="0"><div class="left side"></div><div class="right side"><img class="icon spacer" width="1" height="1" alt="" aria-hidden="true" src="https://school.moodledemo.net/theme/image.php/boost/core/1636912874/spacer" /></div><div class="content"><div class="section_availability"><div class="availabilityinfo ishidden">
    ...
    <div
    id="drawer-619161357ff976191613573b2717"
    ...
    tabindex="0"
>
            <div id="message-drawer-619161357ff976191613573b2717" class="message-app" data-region="message-drawer" role="region">
            ...
            <div class="body-container position-relative" data-region="body-container">
                ...
                >
                    ...
                    <div class="d-flex flex-column h-100">
                        <div class="p-3 border-bottom">
                            <ul class="nav nav-pills nav-fill" role="tablist">
                                <li class="nav-item">
                                    <a
                                        id="contacts-tab-619161357ff976191613573b2717"
                                        class="nav-link active"
                                        href="#contacts-tab-panel-619161357ff976191613573b2717"
                                        data-toggle="tab"
                                        data-action="show-contacts-section"
                                        role="tab"
                                        aria-controls="contacts-tab-panel-619161357ff976191613573b2717"
                                        aria-selected="true"
                                    >
                                        Contacts
                                    </a>
                                ...
                                <li class="nav-item">
                                    <a
                                        id="requests-tab-619161357ff976191613573b2717"
                                        class="nav-link"
                                        href="#requests-tab-panel-619161357ff976191613573b2717"
                                        data-toggle="tab"
                                        data-action="show-requests-section"
                                        role="tab"
                                        aria-controls="requests-tab-panel-619161357ff976191613573b2717"
                                        aria-selected="false"
                                    >
                                        Requests
                                        <span class="badge badge-primary bg-primary ml-2 hidden"
                    ...
                    data-user-id="56"
                                        id="contacts-tab-panel-619161357ff976191613573b2717"
                    data-section="contacts"
                    role="tabpanel"
                    aria-labelledby="contacts-tab-619161357ff976191613573b2717"
                ...
                >
                    ...
                    data-region="lazy-load-list"
                    data-user-id="56"
                                        id="requests-tab-panel-619161357ff976191613573b2717"
                    data-section="requests"
                    role="tabpanel"
                    aria-labelledby="requests-tab-619161357ff976191613573b2717"
                ...
                >
                    ...
                    <div id="message-drawer-view-overview-container-619161357ff976191613573b2717" class="d-flex flex-column h-100" style="overflow-y: auto">
                            ...
                            >
                                <div id="view-overview-favourites-toggle" class="card-header" data-region="toggle">
                                    <button
                                        ...
                                        data-toggle="collapse"
                                        data-target="#view-overview-favourites-target-619161357ff976191613573b2717"
                                        aria-expanded="false"
                                        aria-controls="view-overview-favourites-target-619161357ff976191613573b2717"
                                    >
                                ...
                                data-region="lazy-load-list"
                                data-user-id="56"
                                            id="view-overview-favourites-target-619161357ff976191613573b2717"
            aria-labelledby="view-overview-favourites-toggle"
            data-parent="#message-drawer-view-overview-container-619161357ff976191613573b2717"
                            ...
                            >
                                <div id="view-overview-group-messages-toggle" class="card-header" data-region="toggle">
                                    <button
                                        class="btn btn-link w-100 text-left p-1 p-sm-2 d-flex align-items-center overview-section-toggle collapsed"
                                        data-toggle="collapse"
                                        data-target="#view-overview-group-messages-target-619161357ff976191613573b2717"
                                        aria-expanded="false"
                                        aria-controls="view-overview-group-messages-target-619161357ff976191613573b2717"
                                    >
                                        <span class="collapsed-icon-container">
                                            <i class="icon fa fa-caret-right fa-fw " aria-hidden="true"  ></i>
                                        </span>
                                ...
                                data-region="lazy-load-list"
                                data-user-id="56"
                                            id="view-overview-group-messages-target-619161357ff976191613573b2717"
                            ...
                            >
                                <div id="view-overview-messages-toggle" class="card-header" data-region="toggle">
                                    <button
                                        class="btn btn-link w-100 text-left p-1 p-sm-2 d-flex align-items-center overview-section-toggle collapsed"
                                        data-toggle="collapse"
                                        data-target="#view-overview-messages-target-619161357ff976191613573b2717"
                                        aria-expanded="false"
                                        aria-controls="view-overview-messages-target-619161357ff976191613573b2717"
                                    >
                                        <span class="collapsed-icon-container">
                                            <i class="icon fa fa-caret-right fa-fw " aria-hidden="true"  ></i>
                                        </span>
                                ...
                                data-region="lazy-load-list"
                                data-user-id="56"
                                            id="view-overview-messages-target-619161357ff976191613573b2717"
                        ...
                        <div data-region="settings" class="p-3">
                                    ...
                                    <legend class="sr-only">Accept messages from:</legend>
                                        <div class="custom-control custom-radio mb-2">
                                            <input
                                                ...
                                                id="block-noncontacts-619161357ff976191613573b2717-1"
                                                value="1"
                                            >
                                            <label class="custom-control-label ml-2" for="block-noncontacts-619161357ff976191613573b2717-1">
                                                My contacts only
                                            </label>
                                        </div>
                                        <div class="custom-control custom-radio mb-2">
                                            <input
                                                ...
                                                name="message_blocknoncontacts"
                                                class="custom-control-input"
                                                id="block-noncontacts-619161357ff976191613573b2717-0"
                                                value="0"
                                            >
                                            <label class="custom-control-label ml-2" for="block-noncontacts-619161357ff976191613573b2717-0">
                            ...
                            <div data-preference="entertosend">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" class="custom-control-input" id="enter-to-send-619161357ff976191613573b2717" >
                                    <label class="custom-control-label" for="enter-to-send-619161357ff976191613573b2717">
                                        Use enter to send
                                    </label>
                                </div>
                            </div>
...
require(['jquery', 'core/custom_interaction_events'], function($, CustomEvents) {
    CustomEvents.define('#single_select6191613573b274', [CustomEvents.events.accessibleChange]);
    $('#single_select6191613573b274').on(CustomEvents.events.accessibleChange, function() {
        var ignore = $(this).find(':selected').attr('data-ignore');
        if (typeof ignore === typeof undefined) {
            $('#single_select_f6191613573b273').submit();
        }
    });
});
;
...
function(
    ...
    var uniqid = "619161357d8506191613573b276";
...
function(
    ...
    var toggle = $('#message-drawer-toggle-619161357e6326191613573b278');
    Popover.init(toggle);
});
;

require(['jquery', 'core_message/message_drawer'], function($, MessageDrawer) {
    var root = $('#message-drawer-619161357ff976191613573b2717');
    MessageDrawer.init(root, '619161357ff976191613573b2717', false);
});
;

require(['jquery', 'core/custom_interaction_events'], function($, CustomEvents) {
    CustomEvents.define('#single_select6191613573b2719', [CustomEvents.events.accessibleChange]);
    $('#single_select6191613573b2719').on(CustomEvents.events.accessibleChange, function() {
        var ignore = $(this).find(':selected').attr('data-ignore');
        if (typeof ignore === typeof undefined) {
            $('#single_select_f6191613573b2718').submit();
        }
    });
});
;
...
M.util.js_pending('core/notification'); require(['core/notification'], function(amd) {amd.init(1033, []); M.util.js_complete('core/notification');});;
...
<script src="https://school.moodledemo.net/lib/javascript.php/1636912874/course/format/topics/format.js"></script>
<script>
//<![CDATA[
...
M.util.help_popups.setup(Y);
 M.util.js_pending('random6191613573b2720'); Y.on('domready', function() { M.util.js_complete("init");  M.util.js_complete('random6191613573b2720'); });
})();
//]]>
</script>
